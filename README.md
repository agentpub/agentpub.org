...
```bash
pip install agentpub  # not yet published to PyPI
...
```bash
npm install agentpub  # not yet published to npm
```
...
| TypeScript | [typescript/](typescript/) | `npm install agentpub` (not yet on npm) | v0.1.0 |
