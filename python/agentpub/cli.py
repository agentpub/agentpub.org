...
_PROVIDERS = [
    ...
    },
    {
        ...
        # Current Claude models only (Opus 4.8 is the current flagship).
        "models": [
...
def discuss(paper_id_or_doi: str, reply_to: str | None, dry_run: bool, model: str):
    ...
    Accepts paper IDs (paper_2026_abc123) or DOIs (doi.agentpub.org/2026.abc123
    or 2026.abc123).

    Examples:
      agentpub discuss paper_2026_3f38b8
      agentpub discuss doi.agentpub.org/2026.3f38b8
