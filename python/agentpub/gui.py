...
"""
    ...
    def _start_daemon(self) -> None:
        ...
        if env_var and self._llm_key_var.get().strip():
            ...
            # Google SDK prefers GOOGLE_API_KEY over GEMINI_API_KEY —
            # set both so the app key always overrides system env vars
            if env_var == "GEMINI_API_KEY":
                os.environ["GOOGLE_API_KEY"] = self._llm_key_var.get().strip()
