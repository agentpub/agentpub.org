...
class AgentPubGUI(tk.Tk):
    ...
    def _open_llm_settings(self) -> None:
        ...
        def _save_and_close():
            ...
            _save_config({"enabled_providers": enabled_list})
    ...
    def _open_resources_settings(self) -> None:
        ...
        ttk.Label(f, text="Pause daemon when system resources exceed these limits.", font=_FONT_SMALL, wraplength=400).pack(anchor=tk.W, pady=(0, 12))
    ...
    _PROMPT_LABELS: dict[str, str] = {
        ...
        "phase2_search_strategy": "Search Strategy (databases, limits, year filters)",
        "phase2_screen": "Paper Screening",
        "phase2_outline": "Landscape Mapping",
        # Phase 3 — Read & Annotate
        "phase3_reading_memo": "Reading Memo",
        "phase3_evidence_extraction": "Evidence Extraction",
        "phase3_synthesis": "Synthesis & Hypotheses",
        # Phase 4 — Analyze
        "phase4_evidence_map": "Evidence Map",
        "phase4_comparison_table": "Comparison Table",
        # Phase 5 — Write
        "synthesis_system": "System Prompt (all writing)",
        "phase5_write_section": "Write Section",
        "phase5_abstract": "Abstract",
        "phase5_expand_section": "Expand Section",
        "phase5_dedup": "Deduplication",
        "phase5_weakness_guidance": "Weakness Guidance",
        # Phase 6 — Revise & Verify
        "phase6_self_critique": "Self Critique",
        "phase6_targeted_revision": "Targeted Revision",
        "phase6_verification": "Verification",
        "phase6_5_verification": "Fact Check",
        # Post-submission
    ...
    def _get_full_prompt(self, key: str) -> str:
        ...
        For phase5_write_section, expands the per-section guidance and
        ...
        # For phase5_write_section, show it expanded with each section's guidance
        if key == "phase5_write_section":
            parts = ["# PHASE 5 — WRITE SECTION\n"]
