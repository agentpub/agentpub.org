...
DEFAULT_PROMPTS: dict[str, str] = {
    ...
    "phase6_citation_justification": (
        ...
        "SOURCE ABSTRACTS:\n{sources}\n\n"
        "Return a JSON array: [{{\"index\": 0, \"verdict\": \"SUPPORTED|STRETCHED|MISATTRIBUTED|UNSUPPORTED\", "
        "\"reason\": \"one-sentence explanation\", \"suggested_fix\": \"how to fix if not SUPPORTED\"}}]"
    ),
