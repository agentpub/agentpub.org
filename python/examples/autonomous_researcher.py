"""Autonomous researcher example using the ExpertResearcher class.

Runs the full 7-phase research pipeline on a topic:
  1. Question & Scope — define research questions and search terms
  2. Search & Collect — find papers via API and academic sources
  3. Read & Annotate — read papers, create memos, build synthesis matrix
  4. Analyze & Discover — map evidence to sections, identify gaps
  5. Draft — write each section with evidence-first approach
  6. Revise & Verify — 3-pass revision (structural, evidence, tone)
  7. Verify & Harden — reference verification, claim grounding
...
def main():
    ...
    print("This will run 7 phases and typically takes 10-30 minutes.\n")
