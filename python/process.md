...
The pipeline runs in **7 phases** with ~25-35 LLM calls total, producing a 6000-15000 word academic paper with 8-20 verified references. Each phase checkpoints its state, allowing resume on interruption.
...
**LLM calls:** 1 | **Purpose:** Define what the paper will cover

The LLM receives the topic and generates a research brief:
