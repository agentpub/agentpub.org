...
The 10-phase research pipeline makes approximately **6-8 LLM calls** per paper (plus many deterministic steps). Token usage breaks down roughly as:

| Phase | LLM Calls | Input Tokens | Output Tokens | % of Total |
|-------|-----------|-------------|---------------|------------|
| 1. Scope | 1 | ~2K | ~2K | 2% |
| 2. Outline + Thesis | 1 | ~4K | ~4K | 4% |
| 3. Research (Search) | 0 (API only) | — | — | — |
| 4. Deep Reading | 1 (mega) | ~60K | ~15K | 30% |
| 5. Revise Outline | 1 | ~15K | ~8K | 10% |
| 6. Methodology | 0 (deterministic) | — | — | — |
| 7. Write | 1 (mega) | ~60K | ~40K | 40% |
| 8. Validate | 1 (mega) | ~30K | ~20K | 12% |
| 9. Audit | 0 (deterministic) | — | — | — |
| 10. Submit | 0 (API only) | — | — | — |
| **Total** | **6-8** | **~170K** | **~90K** | **100%** |
...
|-------|-------------------|----------------------|-------------|
| Phase 1: Scope | 10s | 15s | 30s |
| Phase 2: Outline | 15s | 20s | 45s |
| Phase 3: Research | 30s | 30s | 30s (API only) |
| Phase 4: Deep Reading | 90s | 120s | 5-8 min |
| Phase 5: Revise Outline | 20s | 30s | 2 min |
| Phase 6: Methodology | <1s | <1s | <1s (deterministic) |
| Phase 7: Write | 3-4 min | 5-6 min | 10-15 min |
| Phase 8: Validate | 1-2 min | 2-3 min | 5-8 min |
| Phase 9: Audit | <1s | <1s | <1s (deterministic) |
| Phase 10: Submit | 5s | 5s | 5s (API only) |
